...
namespace VLO_BOARDS.Migrations
{
    ...
    [Migration("20210402120023_Files")]
    partial class Files
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.AdminProperty", b =>
                {
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.BanUsersProperty", b =>
                {
                    b.HasBaseType("AccountsData.Models.DataModels.Abstracts.Property");
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.EditOrDeleteProperty", b =>
                {
                    b.HasBaseType("AccountsData.Models.DataModels.Abstracts.Property");
                    ...
                    b.ToTable("EditOrDeleteProperty");
                });
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.ReadProperty", b =>
                {
                    b.HasBaseType("AccountsData.Models.DataModels.Abstracts.Property");
                    ...
                    b.ToTable("ReadProperty");
                });

            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.ViewProperty", b =>
                {
                    b.HasBaseType("AccountsData.Models.DataModels.Abstracts.Property");
                    ...
                    b.ToTable("ViewProperty");
                });

            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.WriteProperty", b =>
                {
                    b.HasBaseType("AccountsData.Models.DataModels.Abstracts.Property");
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Abstracts.Property", b =>
                {
                    ...
                    b.HasOne("AccountsData.Models.DataModels.Thread", null)
                        .WithMany("defaultProperties")
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.AdminProperty", b =>
                {
                    b.HasOne("AccountsData.Models.DataModels.Abstracts.Property", null)
                        .WithOne()
                        .HasForeignKey("AccountsData.Models.DataModels.Implementations.Properties.AdminProperty", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.BanUsersProperty", b =>
                {
                    b.HasOne("AccountsData.Models.DataModels.Abstracts.Property", null)
                        .WithOne()
                        .HasForeignKey("AccountsData.Models.DataModels.Implementations.Properties.BanUsersProperty", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.EditOrDeleteProperty", b =>
                {
                    b.HasOne("AccountsData.Models.DataModels.Abstracts.Property", null)
                        .WithOne()
                        .HasForeignKey("AccountsData.Models.DataModels.Implementations.Properties.EditOrDeleteProperty", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.ReadProperty", b =>
                {
                    b.HasOne("AccountsData.Models.DataModels.Abstracts.Property", null)
                        .WithOne()
                        .HasForeignKey("AccountsData.Models.DataModels.Implementations.Properties.ReadProperty", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.ViewProperty", b =>
                {
                    b.HasOne("AccountsData.Models.DataModels.Abstracts.Property", null)
                        .WithOne()
                        .HasForeignKey("AccountsData.Models.DataModels.Implementations.Properties.ViewProperty", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AccountsData.Models.DataModels.Implementations.Properties.WriteProperty", b =>
                {
                    b.HasOne("AccountsData.Models.DataModels.Abstracts.Property", null)
                        .WithOne()
                        .HasForeignKey("AccountsData.Models.DataModels.Implementations.Properties.WriteProperty", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
